    ...
    >
      ...
      >
        ...
        <p style={{
          ...
          “잠을 조금 설쳤지만 끝까지 활동을 잘 마쳤어요. 가족과 관련된 질문을 특히 잘 떠올리셨어요.”
        </p>
        ...
        <div style={{ width: '100%', display: 'flex', gap: '10px', marginBottom: '80px' }}>
          <div style={summaryBoxStyle}>
            <span style={{ fontSize: '16px', fontWeight: 500, color: '#797980' }}>수행 활동</span>
            <p style={{ fontSize: '28px', fontWeight: 700, color: '#0D0D0D', margin: 0 }}>5개</p>
          </div>
          <div style={summaryBoxStyle}>
            <span style={{ fontSize: '16px', fontWeight: 500, color: '#797980' }}>회상 성공</span>
            <p style={{ fontSize: '28px', fontWeight: 700, color: '#0D0D0D', margin: 0 }}>3회</p>
          </div>
          <div style={summaryBoxStyle}>
            <span style={{ fontSize: '16px', fontWeight: 500, color: '#797980' }}>힌트 사용</span>
            <p style={{ fontSize: '28px', fontWeight: 700, color: '#0D0D0D', margin: 0 }}>2회</p>
          </div>
          <div style={summaryBoxStyle}>
            <span style={{ fontSize: '16px', fontWeight: 500, color: '#797980' }}>다시 말하기</span>
            <p style={{ fontSize: '28px', fontWeight: 700, color: '#0D0D0D', margin: 0 }}>1회</p>
          </div>
        </div>
        ...
        <div style={{ width: '100%', display: 'flex', gap: '25px', marginBottom: '80px' }}>
          <div style={{
            flex: 1,
            height: '149px',
            borderRadius: '10px',
            ...
            <span style={{ fontSize: '18px', fontWeight: 700, color: '#0D0D0D' }}>잘 떠올렸어요 👍</span>
        ...
        <div style={{ width: '100%', display: 'flex', gap: '16px', marginBottom: '80px' }}>
          <div style={{ ...tagStyle, width: '164px' }}>건강 상태 : 좋음</div>
          <div style={{ ...tagStyle, width: '121px' }}>수면 : 보통</div>
          <div style={{ ...tagStyle, width: '140px' }}>기분 : 안정적</div>
        </div>
