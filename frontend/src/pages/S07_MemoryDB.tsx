...
import imgUpload from '../assets/up-loading.png'; // 업로드 아이콘
import imgPolygon from '../assets/Polygon 2.svg'; // TTS 재생 삼각형 아이콘
